...
- **G–H — Travel:** Enter one-way road time. Verify 119/120 min = $0; 121/149/150 = $35; 151/180 = $70; 181/210 = $105; 240 = $140; 241 = $175 at $35 per started additional round-trip hour. Confirm the four-hour total round-trip allowance, rounding after total excess time, no proration/mileage/labor time, and one charge for Installation + Setup on the same trip. Override with a reason and inspect audit history. Verify $1,000 + $35 − $250 = $785 for a 150-minute one-way trip.
