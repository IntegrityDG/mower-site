...
export default function PricingAdminPage() {
    ...
    if (authed === null)
        return <main className="min-h-screen bg-slate-100 p-6">Loading adminÃ¢â‚¬Â¦</main>;
    if (!authed)
