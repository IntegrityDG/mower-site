...
export default function HomeReviews() {
  ...
  return (
    <section className="ids-reviews-background border-y border-slate-700 px-6 py-20 text-white md:px-10">
      <div className="mx-auto max-w-7xl">
        ...
        {loaded && reviews.length > 0 ? (
          ...
          <div className="mt-10 rounded-[2rem] border border-dashed border-emerald-300 bg-white/95 p-10 text-center text-slate-950 backdrop-blur-sm">
