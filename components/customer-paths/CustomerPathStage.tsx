...
import NationwidePurchaseFlow from "./purchase/NationwidePurchaseFlow";
...
export default function CustomerPathStage({
        ...
        <div className="grid lg:grid-cols-[1.15fr_0.85fr]">
          <div className="p-8 md:p-12">
            ...
            <div className="mt-8 rounded-2xl border border-emerald-200 bg-emerald-50 px-5 py-4 text-sm leading-6 text-emerald-950">
              Your selected state, region, and customer path will carry forward
              into the next stage of the website.
            </div>
          </div>
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl">{renderSelectedPath()}</div>
    </section>
  );
}
