...
export default function HomePriceMatch() {
  ...
  return <BulletinBoardContent settings={settings} />;
}

export function BulletinBoardContent({ settings }: { settings: PriceMatchConfig }) {
  if (!settings.enabled) return null;
  return <section aria-labelledby="bulletin-board-heading" className="relative overflow-hidden border-y border-emerald-900 bg-gradient-to-br from-emerald-950 via-slate-950 to-slate-900 px-6 py-20 text-white md:px-10 md:py-24">
    ...
    <div className="relative mx-auto max-w-5xl text-center">
      <h2 id="bulletin-board-heading" className="text-4xl font-black leading-tight tracking-tight sm:text-5xl lg:text-6xl">{settings.heading}</h2>
