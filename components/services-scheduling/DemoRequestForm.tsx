    ...
    <form onSubmit={submit} className="space-y-8 rounded-[2rem] border border-slate-200 bg-white p-5 shadow-xl shadow-slate-900/5 sm:p-8">
      <fieldset>
        ...
        <div className="mt-4 grid gap-3 sm:grid-cols-2">
          ...
          <label className="cursor-pointer rounded-2xl border p-5 has-[:checked]:border-emerald-600 has-[:checked]:bg-emerald-50"><input type="radio" name="demoFormat" value="party" checked={format === "party"} onChange={() => setFormat("party")} className="mr-3 accent-emerald-700" /><strong>YES — Make It a Demo Party &amp; Unlock Amazing Benefits!</strong><span className="mt-2 block text-sm leading-6 text-slate-600">Invite up to 5 friends. Earn back the $100 fee, unlock up to $100 off regular MSRP, receive up to $150 in food and drinks, and earn Tier 1-only direct referral rewards: Lymow $50, Yarbo $100, or Pandag $750 per qualifying purchase.</span></label>
        </div>
      </fieldset>
