    ...
    <header className="border-b border-slate-200 bg-white">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-4 sm:gap-5 sm:px-8">
        ...
        <nav className="flex min-w-0 items-center gap-2 text-sm font-bold sm:gap-4">
          ...
          <Link href={quoteOnly ? "/pandag/project-quote" : buildHref} className="whitespace-nowrap rounded-xl bg-slate-950 px-3 py-3 text-xs text-white hover:bg-emerald-700 sm:px-4 sm:text-sm">
