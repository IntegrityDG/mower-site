...
export default function ScheduleDemoModal({
  ...
  return <Link href={`/services-scheduling?service=demo&source=${encodeURIComponent(source)}#services-top`} className={triggerClassName} onClick={onClick}>Schedule Service/Demo</Link>;
}
