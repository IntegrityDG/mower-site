export type CheckoutPaymentMethod = "card" | "ach";
...
export type PaymentStatus = "unpaid" | "processing" | "paid" | "failed" | "partially_refunded" | "refunded" | "disputed";
export type FulfillmentStatus = "not_ready" | "pending" | "fulfilled" | "canceled";
export type PaymentAttemptStatus = "creating" | "open" | "completed" | "processing" | "succeeded" | "failed" | "expired";
...
export type OrderPriceSnapshot = {
  ...
  subtotalCents: number; discountCents: 0; feeCents: 0; shippingCents: 0; taxCents: 0;
  totalCents: number; paymentMethod: CheckoutPaymentMethod; pricedAt: string;
  catalogSources: readonly CatalogSourceReference[];
  warnings: readonly string[];
  safeMetadata: { phase: "4B1"; adjustments: "not_implemented" };
};
