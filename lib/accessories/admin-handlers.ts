...
import { ACCESSORY_AVAILABILITY_STATUSES, type AccessoryAvailabilityStatus } from "./types";
type Deps = { isAdmin: () => Promise<boolean>; read: () => Promise<any>; saveSettings: (v:any)=>Promise<any>; saveItem:(v:any,id?:string)=>Promise<any>; setAvailability:(id:string,status:AccessoryAvailabilityStatus)=>Promise<any> };
